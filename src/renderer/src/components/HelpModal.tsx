        ...
        <div className="max-h-[calc(80vh-60px)] overflow-y-auto p-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="rounded bg-muted p-3">
                <ul className="space-y-1">
                  ...
                  <li>
                    <strong>Drag node</strong> - Move node on canvas
                  </li>
                  <li>
                    <strong>Drag from handle</strong> - Connect nodes
                  </li>
                  <li>
                    <strong>Click canvas</strong> - Deselect node
                  </li>
                  <li>
          ...
          <section className="mb-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="rounded border border-purple-500/30 bg-purple-500/10 p-3">
                ...
                <p className="text-muted-foreground">
                  Displays choices to the player. Each choice has its own output
                  handle. Supports hide/disable conditions.
                </p>
              </div>
              <div className="rounded border border-blue-500/30 bg-blue-500/10 p-3">
                <strong className="text-blue-500">Action Node</strong>
                <p className="text-muted-foreground">
                  Executes actions: scripts, set variables, set switches, common
                  events, show text, or plugin commands.
                </p>
              </div>
              <div className="rounded border border-amber-500/30 bg-amber-500/10 p-3">
                <strong className="text-amber-500">Condition Node</strong>
                <p className="text-muted-foreground">
                  Branches based on switches, variables, or scripts. Has True
                  (green) and False (red) outputs.
                </p>
              </div>
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
              ...
              <li>
                Use hide conditions to show choices only when conditions are met
              </li>
              <li>
                Use disable conditions to gray out choices but still show them
              </li>
              <li>
                Auto-save is enabled when the file has been saved at least once
              </li>
              <li>
          ...
          <section className="mt-6 border-t border-border pt-4">
            <p className="text-center text-sm text-muted-foreground">
              <strong>MZ Interaction Builder</strong> v1.0.0
              <br />
